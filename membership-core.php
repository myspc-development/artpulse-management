...
// 4. Admin settings page for membership configuration
...
// 5. Shortcode: [membership_status] for frontend display
function artpulse_membership_status_shortcode() {
    ...
    echo '<p><strong>Auto-Renew:</strong> ' . ($renew ? 'Enabled' : 'Disabled') . '</p>';
    echo '</div>';
    return ob_get_clean();
}
