...
class RsvpEndpointTest extends TestCase
{
    ...
    public function test_toggle_rsvp_invalid_event()
    {
        Stubs::$posts = [];
        $endpoint = new RsvpEndpoint();
        $request = new WP_REST_Request();
