...
class PortfolioManager
{
    ...
    public static function renderLinkMetaBox($post)
    {
        ...
        wp_nonce_field('ap_portfolio_meta', 'ap_portfolio_meta_nonce');
    ...
    public static function savePortfolioMeta($post_id)
    {
        ...
        if (!isset($_POST['ap_portfolio_meta_nonce']) || !wp_verify_nonce($_POST['ap_portfolio_meta_nonce'], 'ap_portfolio_meta')) return;
